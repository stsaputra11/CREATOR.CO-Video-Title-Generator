...
const main="calm rain ambient";
const rel=[
 "calm rain ambient work",
 "calm rain ambient focus",
 "calm rain ambient night",
 "calm rain ambient cozy",
 "calm rain",
 "rain ambient",
 "calm ambient",
 "calm rain ambient cafe jazz",
 "calm rain ambient work music"
];
const out=buildMetaTagKeywords(main,rel,"Jazz / Bossa Nova","Work");
console.log(out.join(", "));
for(const kw of out){
 console.log(kw,"=>",metaPhrase(kw).split(" ").filter(Boolean).length,"words");
}
